...
# см. алиасы easydataset/zakupki5500 -> zakupki у DOMAIN_SYSTEM_PROMPTS выше:
# та же логика — это варианты одного домена закупок, не отдельные промпты.
DOMAIN_QUESTIONS["easydataset"] = DOMAIN_QUESTIONS["zakupki"]
DOMAIN_QUESTIONS["zakupki5500"] = DOMAIN_QUESTIONS["zakupki"]
